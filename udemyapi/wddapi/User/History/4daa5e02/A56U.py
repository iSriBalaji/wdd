...
@router.delete("/delete/{delete_device_id}", status_code=status.HTTP_204_NO_CONTENT)
async def delete_device(db:db_dependency, delete_device_id: int = Path(gt=0)): #path gives extra validation to path parameters
    """
